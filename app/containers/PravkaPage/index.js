  ...
  return (
    <>
      ...
      <section className="page-content">
        ...
        <p>
          Автомастерские низкого уровня в основном используют непрофессиональные
          технические приспособления, что влечет неполное или неточное
          восстановление геометрии колёсного диска. В свою очередь, это приводит
          к поломкам подвески авто. Чтобы не платить дважды и сберечь самый
          ценный ресурс – время, стоит обращаться только к профессионалам,
          работающим на высокоточном оборудовании. То есть к нам!
        </p>
        ...
        <p>
          ...
          невозможно. Покупка новых колёсных дисков – сложное и затратное дело,
          поэтому ремонт от BIKOLOR – оптимальный выход из ситуации.
        </p>
        <p>
        ...
        <p>
          Действует система доставки: сотрудник может забрать диски для правки и
          доставить их обратно по указанному адресу.{' '}
        </p>
      </section>
